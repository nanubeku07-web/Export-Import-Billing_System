...
import { Grid3x3, List, Search, AlertCircle, Package } from 'lucide-react';
        ...
        <UserLayout>
            <div className="inventory">
                ...
                <div className="inventory-header">
                    <div>
                        <h1>My Inventory</h1>
                        <p style={{ color: 'var(--text-secondary)', marginTop: '8px' }}>View your product stock levels</p>
                    </div>
                </div>
                ...
                {/* Content - View Only (No Edit/Delete buttons) */}
                {viewMode === 'grid' ? (
